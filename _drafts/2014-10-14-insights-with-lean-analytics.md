...
In this post i'll share my expierences of the last two years on how i did the transition from a data analyst to a data scientist to generate actionable insights that matter. The areas i'll touch are settings the goals, building a team, structures and culture, building a technical infrastructure, defining a lean process, Choosing the right metrics and making predictions.
